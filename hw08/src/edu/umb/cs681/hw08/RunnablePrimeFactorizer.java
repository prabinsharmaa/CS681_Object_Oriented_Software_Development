...
public class RunnablePrimeFactorizer extends PrimeFactorizer implements Runnable {
	...
	public static void main(String[] args) {
		...
		// Factorization of 5642 with two threads
		System.out.println("Factorization of 5642");
		runnables.add( new RunnablePrimeFactorizer(5642, 2, (long)Math.sqrt(5642)/2 ));
		runnables.add( new RunnablePrimeFactorizer(5642, 1+(long)Math.sqrt(5642)/2, (long)Math.sqrt(5642) ));
